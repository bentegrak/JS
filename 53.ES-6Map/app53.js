...
// Map (JS Data Structure) Nedir?
//
// 1) Key - Value mantığıyla çalışır (object gibi).
// 2) Key her tip olabilir (string, number, object, function).
// 3) Sıralıdır (eklenme sırasını korur).
//
// Kullanım:
// const map = new Map();
// map.set("name", "Furkan");
...
// Dolaşma:
// map.keys()   → key’ler
// map.values() → value’lar
// map.entries()→ [key, value]
//
// Özet: Object’in daha güçlü, daha temiz hali.
