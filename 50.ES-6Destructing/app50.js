...
// Destructuring (Dağıtma) Nedir?
//
// 1) Dizi veya objeden değerleri TEK TEK almak yerine
//    tek satırda değişkene ayırmamızı sağlar.
//
// 2) Kod kısalır ve okunabilirlik artar.
//
// 3) Sıra önemliyse → Array destructuring
//    İsim önemliyse → Object destructuring
//
// Örnek:
// const user = { name: "Furkan", age: 24 };
// const { name, age } = user;
//
// Özet: Daha az kod, daha temiz okuma.
